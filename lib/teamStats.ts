...
export function calculateTeamRecords(
  ...
  return {
    ...
    team: {
      ...
      highestSuccessfulChase: null,
      biggestWin: bestWin,
      biggestLoss: { margin: '—', opponent: '—', date: '—' },
      highestRunRate: null,
      lowestRunRate: null,
      ...
      mostBoundariesInMatch: null,
      mostSixesInMatch: null,
      mostWicketsInMatch: null,
    },
  };
}
